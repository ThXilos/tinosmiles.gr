...
app.post("/api/sendemail", async (req, res) => {
  ...
  <body style="background-color:#f7f7f7; font-family:Arial, sans-serif; font-size:16px; line-height:1.5; color:#333333;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; margin:0 auto;">
      ...
      <tr>
        <td align="left" bgcolor="#ffffff" style="border-radius:5px; box-shadow:0px 2px 5px rgba(0,0,0,0.1); padding:50px 50px 25px;">
          ...
          <p style="margin:40px 0 0;color:rgb(10, 150, 149);font-weight:600;">In the meantime&nbsp;click&nbsp;the button below to check out&nbsp;a&nbsp;our guide from Tinos&nbsp;with our tips&nbsp;on what to see and where to go.</p>
      ...
      <tr>
        <td align="center" bgcolor="#ffffff" style="border-radius:5px; box-shadow:0px 2px 5px rgba(0,0,0,0.1); padding:20px;">
          ...
          <p style="margin:0; font-size:14px; color:#777777;">&nbsp;Car Rental Services &nbsp;|&nbsp;Ag.markos,     Tinos 84200<br/>GNTO Reg. No:1178E81000946601&nbsp;|&nbsp;
